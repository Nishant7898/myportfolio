  ...
  return (
    <section className="bg-[#0f0f0f] rounded-2xl sm:rounded-3xl md:rounded-[50px] text-white py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-2 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          A <span className="text-cyan-400 font-medium">Frontend Developer</span> who loves
          building modern, responsive, and user-friendly web applications. I
          work mainly with <span className="text-yellow-400 font-medium">React</span>,{" "}
          <span className="text-blue-400 font-medium">Redux</span>, and{" "}
          <span className="text-green-400 font-medium">Tailwind CSS</span>.
        </motion.p>

        {/* Skills / Highlights */}
        <div className="grid grid-cols-1 font-lexend-exa sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8 mt-6 sm:mt-8 md:mt-10">
          {[
            {
